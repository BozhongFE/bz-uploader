(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('object-assign'), require('promise-polyfill')) :
	typeof define === 'function' && define.amd ? define(['object-assign', 'promise-polyfill'], factory) :
	(global['bz-uploader'] = factory(global.ObjectAssign,global.Promise));
}(this, (function (ObjectAssign,Promise) { 'use strict';
...
var options = {
  ...
  beforeAjax: function beforeAjax() {},
  isBase64: false,
  totalText: '',
  api: '',
};
...
function upload(params, options$$1) {
  var opts = Object.assign({}, options, options$$1);
  var isBase64 = opts.isBase64;
  var api$$1 = '';
  var sendData = {};
  ...
  var ajaxOptions = {
    ...
    complete: function complete() {
      ...
      opts.onComplete.apply(opts, args);
    },
  };
...
var Uploader$2 = function Uploader(options) {
  var this$1 = this;
...
// APP 图片上传
Uploader$2.appUpload = function appUpload (limit, watermark, callback) {
...
Uploader$2.formatAppResult = function formatAppResult (results) {
  if (results) {
...
Uploader$2.prototype.init = function init () {
    var this$1 = this;
...
Uploader$2.prototype.createInput = function createInput () {
...
Uploader$2.prototype.destroy = function destroy () {
...
// 筛选出符号规则的图片
Uploader$2.prototype.filterFile = function filterFile (files, limit) {
    var this$1 = this;
...
Uploader$2.prototype.computedLimit = function computedLimit (results) {
...
Uploader$2.prototype.deleteImage = function deleteImage (amount) {
...
Uploader$2.prototype.listener = function listener () {
    var this$1 = this;
  ...
  input.addEventListener('click', function (event) {
    ...
    if (isApp && !notScheme) {
      event.preventDefault();
      Uploader$2.appUpload(this$1.state.currentImgLimit, opts.watermark, function () {
        notScheme = true;
        input.click();
      });
    }
...
var Uploader = (function (UploaderCore$$1) {
  function Uploader(options) {
    var opts = options;
    if (typeof opts.upload !== 'function') {
      opts.upload = upload;
    }
    UploaderCore$$1.call(this, opts);
  }

  if ( UploaderCore$$1 ) Uploader.__proto__ = UploaderCore$$1;
  Uploader.prototype = Object.create( UploaderCore$$1 && UploaderCore$$1.prototype );
